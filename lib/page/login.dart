...
import 'package:good_healt/model/user.dart';
import 'package:good_healt/page/modul_pasien/index.dart' as IndexPasien;
import 'package:good_healt/page/modul_pasien/signup.dart';
import 'package:good_healt/page/modul_pegawai/index.dart' as IndexPegawai;
import 'package:good_healt/util/session.dart';
import 'package:good_healt/util/util.dart';
  ...
  void tes_logn() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        developer.log(jsonResp['user']['username'].toString());
