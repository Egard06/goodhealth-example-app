...
import 'package:good_healt/model/dokter.dart';
import 'package:good_healt/model/pasien.dart';
import 'package:good_healt/model/reg_poli.dart';
...
class _CreatePageState extends State<CreatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Registrasi Baru')),
      body: Card(
        child: Padding(
      ...
      builder: (BuildContext context, AsyncSnapshot<List<Dokter>> snapshot) {
        if (snapshot.hasData) {
          return DropdownButtonFormField(
            ...
            items: snapshot.data?.map<DropdownMenuItem<Dokter>>((Dokter value) {
