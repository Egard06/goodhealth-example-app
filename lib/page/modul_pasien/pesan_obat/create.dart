...
import 'package:good_healt/model/obat.dart';
import 'package:good_healt/model/pesan_obat.dart';
                ...
                secondary: Visibility(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      initialValue: obats[obats.indexOf(obat)].jumlah
                          .toString(),
                      ...
                      onChanged: (value) {
                        setState(() {
                          obats[obats.indexOf(obat)].jumlah = int.parse(value);
                        });
                        _hitungTotalBiaya();
                      },
                    ),
